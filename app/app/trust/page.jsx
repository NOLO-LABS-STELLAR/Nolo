...
const SECTIONS = [
  {
    id: "how-it-works",
    icon: BookOpen,
    title: "How Nolo Works",
    content: [
      "Nolo is a no-loss prize savings platform. Your deposits are held in smart contracts that generate yield through lending, staking, or other DeFi strategies.",
  ...
  },
  {
    ...
    content: [
      ...
      "The random selection process for prize winners is fair and verifiable. Nolo uses verifiable random functions (VRF) for prize draws.",
  ...
  },
  {
    ...
    content: [
      "Safeguard your wallet's private keys and recovery phrases. Nolo can never recover lost or stolen keys.",
      ...
      "Report suspicious activity or potential vulnerabilities to the Nolo team through the support channel.",
    ]
  },
  {
    ...
    content: [
      ...
      "Market Risk: Crypto markets are volatile. The value of deposited assets may fluctuate independently of Nolo operations.",
  ...
  },
  {
    ...
    content: [
      ...
      "Funds are held in non-custodial smart contracts. Nolo never has direct control over user deposits.",
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <header className="text-center sm:text-left">
        <div className="inline-flex items-center gap-2 rounded-full border border-vault-border bg-vault-surface px-3 py-1 text-xs font-medium text-vault-muted">
          <Shield className="h-3.5 w-3.5 text-nolo-500" />
          Trust & Transparency
        </div>
        ...
        <p className="mt-3 max-w-3xl text-vault-muted">
          Nolo is built on principles of transparency, security, and user empowerment.
              ...
              <div className="space-y-4">
                {section.content.map((paragraph, idx) => (
                  <div key={idx} className="flex gap-3">
                    <CheckCircle2 className="mt-1 h-4 w-4 shrink-0 text-nolo-500/70" />
