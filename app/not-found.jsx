...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-4 text-center">
      <div className="nolo-glass max-w-lg px-8 py-12 sm:px-12 sm:py-16 relative overflow-hidden">
        ...
        <Link
          href="/"
          className="nolo-btn-primary mt-8 inline-flex items-center gap-2 text-base"
        >
          <Home size={18} />
          Return to Home
        </Link>
