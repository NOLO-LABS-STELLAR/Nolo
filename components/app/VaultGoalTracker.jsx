            ...
            <div className="mt-5 w-full max-w-xs space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="5000"
                  className="w-full pl-7 pr-4 py-2 rounded-xl border border-vault-border bg-vault-surface text-vault-text font-semibold focus:border-nolo-400 focus:outline-none focus:ring-2 focus:ring-nolo-400/30"
      ...
      {isEditing ? (
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="relative h-3 w-full overflow-hidden rounded-full bg-vault-border/30" role="progressbar" aria-valuenow={percentage} aria-valuemin={0} aria-valuemax={100} aria-label={`${percentage}% of savings goal reached`}>
            <div
              className="h-full rounded-full bg-gradient-to-r from-nolo-500 to-nolo-400 transition-all duration-500 ease-out"
          ...
          <div className="flex justify-end">
            <button
              ...
              className="text-xs text-vault-muted hover:text-nolo-500 transition-colors underline underline-offset-2"
            >
              Remove goal
            </button>
          </div>
